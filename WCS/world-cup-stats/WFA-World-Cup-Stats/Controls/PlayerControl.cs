...
namespace WFA_World_Cup_Stats.Controls
{
	public partial class PlayerControl : UserControl
	{
		...
		public PlayerControl(Player player, IDataProvider dataProvider)
		{
			Player = player;
		...
		private async void SetPlayerImage()
		{
			using (OpenFileDialog openFileDialog = new OpenFileDialog())
			{
				...
				{
					//TODO: Implement SavePlayerImageAsync method
					/*
					try
					{
		...
		private async void LoadPlayerImage()
		{
			try
			{
				//TODO: Implement GetPlayerImageAsync method in IDataProvider
				/*
		...
		public void ApplyLocalization()
		{
			...
			lblPosition.Text = $"{Strings.Number}: {Player.Position}";
